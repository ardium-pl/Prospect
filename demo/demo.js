...
export async function runPuppeteer(rawData) {
  ...
  const browser = await puppeteer.launch({
    ...
    args: [
      ...
      "--disable-infobars",
      "--disable-sync",
      "--disable-notifications", // Disable "Chrome is being controlled" infobar
    ],
